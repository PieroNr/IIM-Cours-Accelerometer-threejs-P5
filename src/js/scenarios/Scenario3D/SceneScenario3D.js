...
export default class SceneScenario3D extends Scene3D {
    ...
    resize() {
        ...
        if (!!this.wallLeft) {
            ...
            this.wallTop.setSize(this.width/2 - 2 * thickness_, thickness_);
            this.wallRight.setSize(thickness_, this.height);
            this.wallBottom.setSize(this.width/2 - 2 * thickness_, thickness_);

            /** walls position */
            this.wallLeft.setPosition(-this.width / 2 + thickness_ / 2, 0);
            this.wallTop.setPosition(-this.width/ 4, this.height / 4 - thickness_ / 2);
            this.wallRight.setPosition(this.width / 2 - thickness_ / 2, 0);
            this.wallBottom.setPosition(this.width/ 4, -this.height / 4 + thickness_ / 2);
        }
    }
}
